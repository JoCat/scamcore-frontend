    ...
    <header class="index">
      <div class="container">
        ...
        <div class="row lead">
          ...
          <div class="plans">
            <div class="bg">
              {{ translate.header.plans.text }}
              <div>{{ translate.header.plans.price }}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="container products" id="products">
        ...
        <div class="row">
          <div
            ...
            v-for="(product, i) in translate.products.elements"
            :key="i"
          >
            <div class="products-card">
              ...
              <nuxt-link
                class="buy"
                :disabled="product.link.disabled"
        ...
        <a class="more" href="#" @click.prevent="serviceToggle()">{{
          translate.products.more
        }}</a>
      </section>
          ...
          <div class="col-12 col-lg-10 col-xl-9 wrapper">
            <div class="row">
              <div
                ...
                v-for="(service, i) in translate.services"
                :key="i"
              >
                <nuxt-link :to="service.link" class="service-card">
                  ...
                  <img
                    class="white"
                    :src="`/images/services/${i + 1}-white.png`"
                    alt=""
                  />
                  {{ service.title }}
                </nuxt-link>
        ...
        <div class="row wrapper">
          <div class="col-12 col-lg-5">
            <button
              ...
              v-for="(solution, i) in translate.solutions.elements"
              :key="i"
            >
...
export default Vue.extend({
  data() {
    return {
      serviceShow: false,
      selectedSolution: this.$getTranslate(translate).solutions.elements[0]
        .card,
    };
  },
  computed: {
  ...
  ru: {
    header: {
      lead: {
        ...
        description:
          "Мы предоставляем множество разных услуг для Вашего проекта: начиная от бюджетного размещения сайтов, заканчивая производительными выделенными серверами для большого бизнеса.",
      ...
      elements: [
        {
          ...
          description:
            "Выгодные по цене услуги на скоростных SSD/NVME накопителях на базе технологий KVM",
          price: "350 руб",
          link: {
            text: "Заказать",
            href: "/vds",
        ...
        },
        {
          ...
          description:
            "Высокопроизводительные серверы для масштабных проектов, которые требую особую производительность",
          price: "3300 руб",
          link: {
            text: "Заказать",
            href: "/dedicated",
        ...
        },
        {
          ...
          description:
            "Идеальный бюджетный вариант для поддержания небольшого проекта без траты времени на установку ПО",
          price: "110 руб",
          link: {
            text: "Скоро",
            href: "#",
      ...
      elements: [
        {
          ...
          card: {
            ...
            description:
              "Мы используем лучшее оборудование и комплектующие, чтобы гарантировать стабильную работу и uptime не менее 99,92%.",
          },
        },
        {
          ...
          card: {
            ...
            description:
              "Мы ценим Ваш выбор и предлагаем лучшие условия сотрудничества - выгодные тарифы и бонусы для наших клиентов!",
          },
        },
        {
          ...
          card: {
            ...
            description:
              "Наши сотрудники готовы в любое время предоставить услуги по переносу данных Вашего проекта от другого хостинг-провайдера",
          },
        },
        {
          ...
          card: {
            ...
            description:
              "Еженедельно мы обслуживаем сотни клиентов и получаем только положительные отзывы и благодарности.",
          },
        },
      ],
    },
