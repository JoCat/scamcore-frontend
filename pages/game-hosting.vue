        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4">
            <div class="game-hosting-card">
              ...
              <p class="info">1 слот - <span>6 рублей</span></p>
      ...
      <section class="container main-advantages">
        ...
        <div class="row">
          <div
            ...
            v-for="(elements, i) in translate.advantages.elements"
            :key="i"
          >
...
const translate = {
  ru: {
    header: {
      ...
      description:
        "Готовый недорогой хостинг для размещения проекта<br> по Вашей игре уже через несколько секунд после оформления заказа",
      button: {
