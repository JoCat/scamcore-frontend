        ...
        <Modal ref="modal" :title="translate.modal.title">
          <div class="row">
            <div class="col-6 server-info">
              ...
              <div class="price">{{ currentLicense.price }} {{ translate.modal.currency }}</div>
            </div>
            <div class="col-12 col-md-6">
              <input type="text" v-model="form.license" :placeholder="translate.modal.form.license">
              <input type="ip" v-model="form.ip" :placeholder="translate.modal.form.ip">
              <input type="email" v-model="form.email" :placeholder="translate.modal.form.email">
              <a @click="hideModal" target="_blank" :href="getISPLink">{{ translate.modal.form.checkout }}</a>
            </div>
          </div>
        </Modal>
      </section>
